...
class DiscoverAgeCubit extends Cubit<DiscoverAgeState>{
  DiscoverAgeCubit(this._appUserRepository, this._getAuthenticatedUser) : super(DiscoverAgeInitial(10, 100));
  ...
  Future<void> postData() async {
    ...
    var updatedUserInformation = authenticatedUser.copyWith(discoverFromAge: selectedFromAge, discoverToAge: selectedToAge);
