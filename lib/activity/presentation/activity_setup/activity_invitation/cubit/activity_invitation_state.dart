...
abstract class ActivityInvitationState extends Equatable {
  ...
  ActivityInvitationState(this.searchResults, this.friends,
      this.friendRequestsSize, this.invitations);
}

class ActivityInvitationInitial extends ActivityInvitationState {
  ActivityInvitationInitial()
      : super([], const Stream.empty(), const Stream.empty(), []);

  @override
  List<Object?> get props =>
      [searchResults, friends, friendRequestsSize, invitations];
}
...
class ActivityInvitationLoaded extends ActivityInvitationState {
  ActivityInvitationLoaded(
      searchResults, friends, friendRequestsSize, attendees)
