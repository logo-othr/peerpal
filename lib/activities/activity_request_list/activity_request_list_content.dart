...
class ActivityRequestListContent extends StatefulWidget {
  ...
  @override
  State<ActivityRequestListContent> createState() => _ActivityRequestListContentState();
}

class _ActivityRequestListContentState extends State<ActivityRequestListContent> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ActivityRequestListBloc, ActivityRequestListState>(builder: (context, state) {
      return Scaffold(
        appBar: CustomAppBar(
          'Aktivitäten',
          hasBackButton: true,
        ...
        body:
        BlocBuilder<ActivityRequestListBloc, ActivityRequestListState>(builder: (context, state) {
