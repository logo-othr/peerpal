part of 'activity_overview_cubit.dart';
 ...
 class ActivityOverviewState extends Equatable {
  ...
  const ActivityOverviewState(this.activity, this.activityCreator, this.attendees, this.invitationIds);
  @override
  List<Object?> get props => [activity, activityCreator, attendees, invitationIds];
}
...
class ActivityOverviewLoaded extends ActivityOverviewState {
 ...
 ActivityOverviewLoaded(this.activity, this.activityCreator, this.attendees, this.invitationIds) : super(activity, activityCreator, attendees, invitationIds);
