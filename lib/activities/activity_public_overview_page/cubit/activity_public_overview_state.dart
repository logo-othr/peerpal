...
class ActivityPublicOverviewState extends Equatable {
  ...
  const ActivityPublicOverviewState(this.activity, this.activityCreator, this.attendees, this.isAttendee);
  @override
...
class ActivityPublicOverviewInitial extends ActivityPublicOverviewState {
  ActivityPublicOverviewInitial() : super(Activity.empty, PeerPALUser.empty, [], false);
...
class ActivityPublicOverviewLoaded extends ActivityPublicOverviewState {
  ...
  ActivityPublicOverviewLoaded(this.activity, this.activityCreator, this.attendees, this.isAttendee) : super(activity, activityCreator, attendees, isAttendee);
