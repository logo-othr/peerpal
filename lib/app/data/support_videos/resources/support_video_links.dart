...
class SupportVideos {
  static final Map<VideoIdentifier, SupportVideo> links = {
    VideoIdentifier.discover: SupportVideo(
        identifier: VideoIdentifier.discover,
        link:
    ...
    VideoIdentifier.activity: SupportVideo(
        identifier: VideoIdentifier.activity,
        link:
    ...
    VideoIdentifier.activity_invitation: SupportVideo(
        identifier: VideoIdentifier.activity_invitation,
        link:
    ...
    VideoIdentifier.chat: SupportVideo(
        identifier: VideoIdentifier.chat,
        link:
    ...
    VideoIdentifier.chat_request: SupportVideo(
        identifier: VideoIdentifier.chat_request,
        link:
    ...
    VideoIdentifier.settings: SupportVideo(
        identifier: VideoIdentifier.settings,
        link:
    ...
    VideoIdentifier.settings_profile: SupportVideo(
        identifier: VideoIdentifier.settings_profile,
        link:
    ...
    VideoIdentifier.friends: SupportVideo(
        identifier: VideoIdentifier.friends,
        link:
