...
class CustomActivityDialogItem extends StatefulWidget {
  ...
  const CustomActivityDialogItem({required this.name, required this.isOwnCreatedActivity});

  @override
  _CustomActivityDialogItemState createState() => _CustomActivityDialogItemState();
}
